...
#ifndef RMW_SWIFTDDS_SHARED_CPP__RMW_COMMON_HPP_
#define RMW_SWIFTDDS_SHARED_CPP__RMW_COMMON_HPP_
...
RMW_SWIFTDDS_SHARED_CPP_PUBLIC
rmw_ret_t __rmw_count_services(
  const char * identifier,
  const rmw_node_t * node,
  const char * service_name,
  size_t * count);
...
RMW_SWIFTDDS_SHARED_CPP_PUBLIC
rmw_ret_t
__rmw_get_gid_for_client(const char * identifier, const rmw_client_t * client, rmw_gid_t * gid);
...
__rmw_destroy_publisher(
  const char * identifier, const rmw_node_t * node,
...
RMW_SWIFTDDS_SHARED_CPP_PUBLIC
rmw_ret_t __rmw_destroy_service(
  const char * identifier, rmw_node_t * node,
...
#endif  // RMW_SWIFTDDS_SHARED_CPP__RMW_COMMON_HPP_
