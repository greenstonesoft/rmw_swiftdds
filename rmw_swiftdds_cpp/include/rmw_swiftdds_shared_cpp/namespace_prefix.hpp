...
#ifndef RMW_SWIFTDDS_SHARED_CPP__NAMESPACE_PREFIX_HPP_
#define RMW_SWIFTDDS_SHARED_CPP__NAMESPACE_PREFIX_HPP_
...
extern "C" {
RMW_SWIFTDDS_SHARED_CPP_PUBLIC extern const char * const ros_topic_prefix;
RMW_SWIFTDDS_SHARED_CPP_PUBLIC extern const char * const ros_service_requester_prefix;
RMW_SWIFTDDS_SHARED_CPP_PUBLIC extern const char * const ros_service_response_prefix;

RMW_SWIFTDDS_SHARED_CPP_PUBLIC extern const std::vector<std::string> _ros_prefixes;
}  // extern "C"
...
#endif  // RMW_SWIFTDDS_SHARED_CPP__NAMESPACE_PREFIX_HPP_
