...
#ifndef RMW_SWIFTDDS_SHARED_CPP__INIT_RMW_CONTEXT_IMPL_HPP_
#define RMW_SWIFTDDS_SHARED_CPP__INIT_RMW_CONTEXT_IMPL_HPP_
...
/// Increment `rmw_context_impl_t` reference count, destroying it if the count
/// reaches zero.
/**
...
#endif  // RMW_SWIFTDDS_SHARED_CPP__INIT_RMW_CONTEXT_IMPL_HPP_
