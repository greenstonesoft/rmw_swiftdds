...
#ifndef RMW_SWIFTDDS_SHARED_CPP__NAMES_HPP_
#define RMW_SWIFTDDS_SHARED_CPP__NAMES_HPP_
 ...
 */
inline std::string
_mangle_topic_name(const char * prefix, const char * base, const char * suffix = nullptr)
{
 ...
 * \param[in] suffix Optional suffix for topic name.
 */
inline std::string _create_topic_name(
...
#endif  // RMW_SWIFTDDS_SHARED_CPP__NAMES_HPP_
