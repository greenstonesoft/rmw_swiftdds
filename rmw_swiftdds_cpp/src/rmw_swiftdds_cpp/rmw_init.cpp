...
#include "rmw_swiftdds_shared_cpp/rmw_init.hpp"
...
{
  return rmw_swiftdds_shared_cpp::rmw_init_options_init(
    greenstone_swiftdds_identifier, init_options, allocator);
}

rmw_ret_t rmw_init_options_copy(const rmw_init_options_t * src, rmw_init_options_t * dst)
{
  return rmw_swiftdds_shared_cpp::rmw_init_options_copy(greenstone_swiftdds_identifier, src, dst);
}

rmw_ret_t rmw_init_options_fini(rmw_init_options_t * init_options)
{
  return rmw_swiftdds_shared_cpp::rmw_init_options_fini(
...
rmw_ret_t rmw_init(const rmw_init_options_t * options, rmw_context_t * context)
{
  ...
  context->implementation_identifier = greenstone_swiftdds_identifier;
