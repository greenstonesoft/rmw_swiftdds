...
{
  return rmw_swiftdds_shared_cpp::__rmw_get_subscriber_names_and_types_by_node(
...
rmw_ret_t rmw_get_publisher_names_and_types_by_node(
  ...
  rmw_names_and_types_t * topic_names_and_types)
{
  return rmw_swiftdds_shared_cpp::__rmw_get_publisher_names_and_types_by_node(
    greenstone_swiftdds_identifier,
    node,
    allocator,
    node_name,
...
{
  return rmw_swiftdds_shared_cpp::__rmw_get_service_names_and_types_by_node(
    greenstone_swiftdds_identifier,
    node,
    allocator,
    node_name,
...
rmw_ret_t rmw_get_client_names_and_types_by_node(
  ...
  rmw_names_and_types_t * service_names_and_types)
{
  return rmw_swiftdds_shared_cpp::__rmw_get_client_names_and_types_by_node(
    greenstone_swiftdds_identifier,
    node,
    allocator,
    node_name,
