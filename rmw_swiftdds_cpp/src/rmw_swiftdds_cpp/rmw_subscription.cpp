  ...
  auto cleanup_subscription = rcpputils::make_scope_exit(
    [participant_info, subscription]() {
      ...
      if (RMW_RET_OK != rmw_swiftdds_shared_cpp::destroy_subscription(
        greenstone_swiftdds_identifier, participant_info, subscription))
      {
...

  {
    ...
    if (RMW_RET_OK != rmw_ret) {
      ...
      static_cast<void>(common_context->graph_cache.dissociate_reader(
        info->subscription_gid_, common_context->gid, node->name, node->namespace_));
      rmw_ret = rmw_swiftdds_shared_cpp::destroy_subscription(
        greenstone_swiftdds_identifier, participant_info, subscription);
      if (RMW_RET_OK != rmw_ret) {
        RMW_SAFE_FWRITE_TO_STDERR(rmw_get_error_string().str);
        RMW_SAFE_FWRITE_TO_STDERR(" during '" RCUTILS_STRINGIFY(__function__) "' cleanup\n");
  ...
  size_t * publisher_count)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_subscription_count_matched_publishers(
    subscription,
    publisher_count);
}
  ...
  rmw_qos_profile_t * qos)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_subscription_get_actual_qos(subscription, qos);
}
  ...
  const rmw_subscription_content_filter_options_t * options)
{
  ...
  RMW_CHECK_TYPE_IDENTIFIERS_MATCH(
    ...
    greenstone_swiftdds_identifier,
    return RMW_RET_INCORRECT_RMW_IMPLEMENTATION);
  rmw_ret_t ret = rmw_swiftdds_shared_cpp::__rmw_subscription_set_content_filter(
  ...
  rmw_subscription_content_filter_options_t * options)
{
  ...
  RMW_CHECK_TYPE_IDENTIFIERS_MATCH(
    ...
    greenstone_swiftdds_identifier,
    return RMW_RET_INCORRECT_RMW_IMPLEMENTATION);
  return rmw_swiftdds_shared_cpp::__rmw_subscription_get_content_filter(
...
rmw_ret_t rmw_destroy_subscription(rmw_node_t * node, rmw_subscription_t * subscription)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_destroy_subscription(
    greenstone_swiftdds_identifier, node, subscription);
}
  ...
  const void * user_data)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_subscription_set_on_new_message_callback(
