  ...
  const rmw_subscription_options_t *subscription_options)
{
  ...
  rmw_subscription_t *subscription =
    rmw_swiftdds_cpp::create_subscription(participant_info,
                                            type_supports,
                                            topic_name,
  ...
  auto cleanup_subscription = rcpputils::make_scope_exit([participant_info, subscription]() {
  ...
  // Update graph
  if(RMW_RET_OK !=
    common_context->add_subscriber_graph(info->subscription_gid_, node->name, node->namespace_))
  {
    return nullptr;
  }
  ...
  size_t *publisher_count)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_subscription_count_matched_publishers(subscription,
                                                                              publisher_count);
}
