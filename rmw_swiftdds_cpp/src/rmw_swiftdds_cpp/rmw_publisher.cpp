  ...
  const rmw_publisher_options_t * publisher_options)
{
  ...
  rmw_publisher_t * publisher = rmw_swiftdds_cpp::create_publisher(
  ...
  auto cleanup_publisher = rcpputils::make_scope_exit(
    [participant_info, publisher]() {
      ...
      if (RMW_RET_OK != rmw_swiftdds_shared_cpp::destroy_publisher(
        greenstone_swiftdds_identifier, participant_info, publisher))
      {
...

  {
    ...
    rmw_ret_t rmw_ret = rmw_swiftdds_shared_cpp::__rmw_publish(
    ...
    if (RMW_RET_OK != rmw_ret) {
      ...
      static_cast<void>(common_context->graph_cache.dissociate_writer(
        info->publisher_gid, common_context->gid, node->name, node->namespace_));
      rmw_ret = rmw_swiftdds_shared_cpp::destroy_publisher(
        greenstone_swiftdds_identifier, participant_info, publisher);
      if (RMW_RET_OK != rmw_ret) {
        RMW_SAFE_FWRITE_TO_STDERR(rmw_get_error_string().str);
        RMW_SAFE_FWRITE_TO_STDERR(" during '" RCUTILS_STRINGIFY(__function__) "' cleanup\n");
  ...
  size_t * subscription_count)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_publisher_count_matched_subscriptions(
    publisher,
    subscription_count);
}
...
{
  return rmw_swiftdds_shared_cpp::__rmw_publisher_assert_liveliness(
    greenstone_swiftdds_identifier,
    publisher);
}
...
{
  return rmw_swiftdds_shared_cpp::__rmw_publisher_wait_for_all_acked(
    greenstone_swiftdds_identifier, publisher, wait_timeout);
}
...
rmw_ret_t rmw_publisher_get_actual_qos(const rmw_publisher_t * publisher, rmw_qos_profile_t * qos)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_publisher_get_actual_qos(publisher, qos);
}
...
rmw_ret_t rmw_borrow_loaned_message(
  ...
  void ** ros_message)
{
  return rmw_swiftdds_shared_cpp::__rmw_borrow_loaned_message(
    greenstone_swiftdds_identifier, publisher, type_support, ros_message);
}
...
rmw_ret_t rmw_return_loaned_message_from_publisher(
  ...
  void * loaned_message)
{
  return rmw_swiftdds_shared_cpp::__rmw_return_loaned_message_from_publisher(
    greenstone_swiftdds_identifier, publisher, loaned_message);
}
...
rmw_ret_t rmw_destroy_publisher(rmw_node_t * node, rmw_publisher_t * publisher)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_destroy_publisher(
    greenstone_swiftdds_identifier, node, publisher);
}
}  // extern "C"
