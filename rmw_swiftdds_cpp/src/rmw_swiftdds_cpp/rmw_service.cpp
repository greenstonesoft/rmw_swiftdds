  ...
  const rmw_qos_profile_t * qos_policies)
{
...

  {
    ...
    rmw_gid_t request_subscriber_gid = rmw_swiftdds_shared_cpp::create_rmw_gid(
      greenstone_swiftdds_identifier, request_reader_guid);
    common_context->graph_cache.associate_reader(
      request_subscriber_gid,
      common_context->gid,
      node->name,
      node->namespace_);
    rmw_gid_t response_publisher_gid = rmw_swiftdds_shared_cpp::create_rmw_gid(
      greenstone_swiftdds_identifier, response_writer_guid);
