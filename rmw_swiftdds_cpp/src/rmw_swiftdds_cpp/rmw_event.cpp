...
{
  return rmw_swiftdds_shared_cpp::__rmw_init_event(
  ...
  const void * user_data)
{
  ...
  return rmw_swiftdds_shared_cpp::__rmw_event_set_callback(rmw_event, callback, user_data);
}

bool rmw_event_type_is_supported(rmw_event_type_t rmw_event_type)
{
  return rmw_swiftdds_shared_cpp::__rmw_event_type_is_supported(rmw_event_type);
}
}  // extern "C"
