...
using Locator_t = greenstone::dds::Locator_t;
using LocatorList_t = greenstone::dds::LocatorList_t;
// using IPLocator = greenstone::dds::IPLocator;
...
{
  if (loc.kind() & (gstone::rtps::LOCATOR_KIND_UDPv4 | gstone::rtps::LOCATOR_KIND_UDPv6)) {
    return RMW_TRANSPORT_PROTOCOL_UDP;
  } else if (loc.kind() & (gstone::rtps::LOCATOR_KIND_TCPv4 | gstone::rtps::LOCATOR_KIND_TCPv6)) {
...
{
  if (loc.kind() & (gstone::rtps::LOCATOR_KIND_UDPv4 | gstone::rtps::LOCATOR_KIND_TCPv4)) {
    return RMW_INTERNET_PROTOCOL_IPV4;
  } else if (loc.kind() & (gstone::rtps::LOCATOR_KIND_TCPv6 | gstone::rtps::LOCATOR_KIND_UDPv6)) {
