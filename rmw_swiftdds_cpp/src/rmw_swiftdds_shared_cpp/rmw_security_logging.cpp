...
// DDS supports the following verbosities:
//   - EMERGENCY_LEVEL
//   - ALERT_LEVEL
//   - CRITICAL_LEVEL
//   - ERROR_LEVEL
...
void add_property(greenstone::dds::PropertySeq & properties, greenstone::dds::Property && property)
{
...
// bool apply_security_logging_configuration(greenstone::dds::PropertyPolicy &
// policy)
// {
// #if HAVE_SECURITY
//   greenstone::dds::PropertySeq properties;
...
//       RMW_SET_ERROR_MSG_WITH_FORMAT_STRING(
//         "%s is not valid: '%s' is not a supported value (use 'true' or
//         'false')", log_publish_variable_name, env_value.c_str());
//       return false;
//     }
...
//     add_property(
//       properties,
//       greenstone::dds::Property(verbosity_property_name, verbosity.c_str()));
//   }
...
//   (void)policy;
//   RMW_SET_ERROR_MSG(
//     "This DDS version doesn't have the security libraries\n"
