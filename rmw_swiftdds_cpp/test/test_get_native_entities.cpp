...
#include "rmw_swiftdds_cpp/get_client.hpp"
#include "rmw_swiftdds_cpp/get_participant.hpp"
#include "rmw_swiftdds_cpp/get_publisher.hpp"
#include "rmw_swiftdds_cpp/get_service.hpp"
#include "rmw_swiftdds_cpp/get_subscriber.hpp"
...
TEST_F(TestNativeEntities, get_domain_participant) {
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_domain_participant(nullptr));
  ...
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_domain_participant(node));
  node->implementation_identifier = implementation_identifier;

  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_domain_participant(node));
}

TEST_F(TestNativeEntities, get_datawriter) {
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_datawriter(nullptr));
  ...
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_datawriter(pub));
  pub->implementation_identifier = implementation_identifier;

  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_datawriter(pub));
...
TEST_F(TestNativeEntities, get_datareader) {
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_datareader(nullptr));
  ...
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_datareader(sub));
  sub->implementation_identifier = implementation_identifier;

  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_datareader(sub));
...
TEST_F(TestNativeEntities, get_service) {
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_request_datareader(nullptr));
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_response_datawriter(nullptr));
  ...
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_request_datareader(srv));
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_response_datawriter(srv));
  srv->implementation_identifier = implementation_identifier;

  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_request_datareader(srv));
  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_response_datawriter(srv));
...
TEST_F(TestNativeEntities, get_client) {
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_request_datawriter(nullptr));
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_response_datareader(nullptr));
  ...
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_request_datawriter(client));
  EXPECT_EQ(nullptr, rmw_swiftdds_cpp::get_response_datareader(client));
  client->implementation_identifier = implementation_identifier;

  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_request_datawriter(client));
  EXPECT_NE(nullptr, rmw_swiftdds_cpp::get_response_datareader(client));
