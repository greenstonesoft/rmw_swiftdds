...
`rmw_swiftdds_cpp` is a [ROS 2](https://docs.ros.org/en/humble) middleware implementation, providing an interface between ROS 2 and [GreenstoneSoft's](https://www.greenstonesoft.com/en_homepage) [Swift DDS](https://github.com/greenstonesoft/greenstone-dds) middleware.
...
For example, see [ROS 2 QoS policies](https://docs.ros.org/en/humble/Concepts/About-Quality-of-Service-Settings.html#qos-policies).
